        ...
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            <a href="javascript:void(0)"><img
              src="https://readymadeui.com/readymadeui-white.svg" alt="logo" class='lg:w-52 w-44 mb-12 inline-block' />
            </a>
            <h2 class="lg:text-4xl text-2xl font-extrabold lg:leading-[50px] text-white">
            ...
            <p class="text-sm mt-6 text-white">Don't have an account <a href="javascript:void(0);" class="text-white font-semibold underline ml-1">Register here</a></p>
          </div>
